...
# ---------- CORS CONFIG (Frontend en localhost:3000) ----------

# Aquí solo permitimos el frontend local. No es "*", así que es mucho más seguro.
ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
]
...
def convolve(req: ConvolutionRequest):
    ...
    try:
        ...
        return {
            ...
            "image_width": 640,                # Hardcoded (mock)
            "image_height": 480,               # Hardcoded (mock)
